...
/*   Updated: 2024/05/27 19:13:52 by mrechuli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_destroy_image(game->mlx, game->txt.a); // mlx_destroy_image niszczy (usuwa) tekstury zaladowane do pamieci. Funkcja usuwa obrazy zaladowane do wskaznika
